...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__shop_cart_component__ = __webpack_require__("../../../../../ClientApp/app/shop/cart.component.ts");
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__shop_cart_component__["a" /* Cart */],
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* RouterModule */].forRoot(routes, {
                useHash: true,
                enableTracing: false //for Debugging of the Routea
            })
        ],
        providers: [__WEBPACK_IMPORTED_MODULE_7__shared_dataService__["a" /* DataService */]],
...
var Checkout = (function () {
    ...
    Checkout.prototype.onCheckout = function () {
        ...
        }, function (err) { return _this.errorMessage = "Faild to serve the order"; });
    };
    return Checkout;
}());
Checkout = __decorate([
...
var DataService = (function () {
    ...
    DataService.prototype.checkout = function () {
        ...
        return this.http.post("/api/orders", this.order, {
            headers: new __WEBPACK_IMPORTED_MODULE_0__angular_common_http__["c" /* HttpHeaders */]().append("Authorization", "Bearer " + this.token)
        })
